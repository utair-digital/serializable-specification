...
specification_11_result = [
    Order(car='Mini', vin=91051650610121691, price=42797, max_speed=123, power=370,
          buyer=Buyer(full_name='Augustina Frederick', age=54, telephone='+7(9**)***-**-**')),
    Order(car='Mini', vin=46178158948220088, price=47745, max_speed=110, power=743,
          buyer=Buyer(full_name='Sixta Goodman', age=62, telephone='+7(9**)***-**-**'))]

specification_12_result = [
    Order(car='Maserati', vin=87451386981840811, price=47730, max_speed=168, power=922,
...
specification_14_result = [
    ...
    Order(car='Ferrari', vin=46457930469348117, price=34619, max_speed=116, power=968,
          buyer=Buyer(full_name='Mariette Valenzuela', age=28, telephone='+7(9**)***-**-**')),
